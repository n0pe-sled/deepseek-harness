...
describe('invariant companion', () => {
  ...
  it('client apply provides ctx.locale seeded with the English common namespace', async () => {
    ...
    // The seeded namespace is occupied; a second registration throws.
    expect(() => (locale as LocaleRuntime).register(COMMON_NS, {})).toThrow('already has a dictionary')
  })
})
